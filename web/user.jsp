...
<div id="reg01" class="modal">
    ...
    <form class="modal-content animate" action="updatebed" method="post">
     ...
     %>
       ...
       <option value="ac">private</option>
       <option value="nonac">Semi-Private</option>
